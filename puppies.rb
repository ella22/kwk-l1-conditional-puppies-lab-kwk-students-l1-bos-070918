...
def some_puppies(number_of_puppies, max)
  if number_of_puppies < (max/2)
    "Good job, Rachel!"
  else 
    "Get back to your animal goals!"
  end 
...
if number_of_puppies == 0 || number_of_cats == 0
 "Good Job Rachel"
elsif number of puppies > 0 && number_of_cats > 0
 "Get back to your animal goalsl!"
  end 
 end 
